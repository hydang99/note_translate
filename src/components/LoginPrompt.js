...
export default function LoginPrompt({ isOpen, onClose, onSuccess, title = "Login Required" }) {
      ...
      <div className="bg-white rounded-lg p-6 w-full max-w-md mx-4">
        ...
        <div className="mb-4">
          <p className="text-sm text-gray-600">
            {isLogin 
              ? "Please log in to save your notes and vocabulary." 
              : "Create an account to save your notes and vocabulary."
            }
          </p>
        </div>
